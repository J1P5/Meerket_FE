...
export const oauthLogin = async ({ code, provider, fcmToken }: IAuthData) => {
  return http.post<IAuthResponse, IAuthData>('/oauth', {
    code,
    provider,
    fcmToken,
  })
